...
if __name__ == '__main__':
    ...
    elif mode == 'generate_b_v_t_v':
        input_file=sys.argv[11]
        output_file=sys.argv[11]+'.result'
        print output_file
        manager.generate_b_v_t_v(input_file=input_file, output_file=output_file)
    elif mode == 'generate_emb':
        input_file=sys.argv[11]
        output_file=sys.argv[11]+'.emb'
        print output_file
        manager.generate_emb(input_file=input_file, output_file=output_file)
