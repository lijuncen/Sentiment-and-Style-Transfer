...
from deep.algorithms.networks.cho_encoder_decoder_topic import RnnEncoderDecoderNetwork
...
class RnnEncoderDecoder(ModelManager) :
    ...
    def __init__(self, dataset_folder, dataset_file, dict_file, stopwords_file, word_embedding_file,
        ...
        self.conf_dict = {'algo_name': algo_name, 'batch_size': 256,
                          ...
                          'save_freq': 100}
        #self.param_path = os.path.join(dataset_folder, 'model', 'dialog', get_params_file_name(self.conf_dict) + '.model')
