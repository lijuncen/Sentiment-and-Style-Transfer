...
from deep.algorithms.networks.lihang_encoder_decoder import LihangEncoderDecoderNetwork
from deep.dataloader.corpus_reader_dialog import CorpusReaderDialog



class LihangEncoderDecoder(ModelManager) :
    ...
    def __init__(self, dataset_folder, dataset_file, dict_file, stopwords_file, word_embedding_file,
        ...
        """
        self.conf_dict = {'algo_name': algo_name, 'batch_size': 1,
                          ...
                          'hidden_dim': 256, 'charset': charset, 'shuffle': False,
                          'save_freq': 10}
        if mode == 'train' :
            self.param_path = \
        ...
        if mode == 'train' :
            ...
            self.cr = CorpusReaderDialog(dataset_file=None,
                                         ...
                                         is_END_available=self.conf_dict['is_END'])
        # set model
        self.model = LihangEncoderDecoderNetwork(n_words=len(self.cr.get_word_dictionary()),
